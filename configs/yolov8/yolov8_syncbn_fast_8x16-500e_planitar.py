...
data_root = "/home/bizon/data/experiments/OD_model/YOLOv7_exp/od_v8_v1_l0"  # Root path of data
# Path of train annotation file
train_ann_file = "/data/old_coco_format/train.json"
# train_data = '/data/od_v7_20_train.csv' # reading from csv
# label_file = ''
train_data_prefix = ""  #'train_data/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = "/data/old_coco_format/val.json"
# val_data = '/data/od_v7_20_val.csv' # reading from csv
val_data_prefix = ""  #'val_data/'  # Prefix of val image path
...
# -----data related-----
img_scale = (1024, 512)  # (512, 256) # width, height
# Dataset type, this will be used to define the dataset
dataset_type = "YOLOv5CocoDataset"  #'PlanitarBatchDataset'
...
lr_factor = 0.001  # Learning rate scaling factor
weight_decay = 0.0005
