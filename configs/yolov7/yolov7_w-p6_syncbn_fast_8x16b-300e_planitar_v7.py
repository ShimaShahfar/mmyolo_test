...
# ========================modified parameters========================
# -----data related-----
img_scale = (512, 1024)  # height, width
...
tta_img_scales = [(512, 1024), (1024, 1024), (1536, 1536)]
...
val_dataloader = dict(
    dataset=dict(
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + '/data/val.json',pipeline=test_pipeline, batch_shapes_cfg=batch_shapes_cfg))
