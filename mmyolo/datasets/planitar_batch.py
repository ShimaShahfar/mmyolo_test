...
from mmdet.datasets import BaseDetDataset, PlanitarDataset
...
class PlanitarBatchDataset(BatchShapePolicyDataset, PlanitarDataset):
    """Dataset for Planitar Dataset.

    We only add `BatchShapePolicy` function compared with ...
    """
    pass